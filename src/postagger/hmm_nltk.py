...
cpd_tagwords = nltk.ConditionalProbDist(cfd_tagwords, nltk.SimpleGoodTuringProbDist)
...
# P(ti | t{i-1})
cpd_tags = nltk.ConditionalProbDist(cfd_tags, nltk.SimpleGoodTuringProbDist)
